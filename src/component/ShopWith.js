...
import data from '../jsondata/ShopWith.json';
...
function ShopWith() {
  ...
  const handleQuickView = (product) => {
    ...
    // Optionally, you can also open the modal programmatically here if needed
    // Example: $('#productModals').modal('show');
  };
  ...
  const FetchBestSellers = async () => {
    ...
    try {
      const response = await ManageAPIsData(`${FRONTEND_PRODUCTS}?lifestyle=1`, 'GET');
      if (!response.ok) {
                ...
                <div className="productList">
                  <div className="container ">
                    <div className="row">
                      ...
                      {/* Bootstrap Modal */}
                      <div className={`modal fade ${selectedProduct ? 'show' : ''}`} id="productModals" tabIndex="-1" role="dialog" aria-labelledby="productModalLabel" aria-hidden={!selectedProduct}>
                                  ...
                                  <div id="poupProductimgs">
                                    ...
                                    <div className="col-md-6 poup-product-view">
                                      ...
                                      {selectedProduct.coming_soon === 2 && (
                                        <div className="price"><h4><i className="fa fa-inr" />{selectedProduct?.discount_price > 0 ? selectedProduct.discount_price : selectedProduct.price}</h4>
