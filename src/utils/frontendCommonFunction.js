...
// Unsubscribe Promotional Communication
export const unsubscribePromotionalCommunication = async (uid, payload) => {
    const responseData = await fetchFromAPI(`${FRONTEND_UNSUBSCRIBE}?userhash=${uid}`, 'GET', payload);
    return responseData;
};
